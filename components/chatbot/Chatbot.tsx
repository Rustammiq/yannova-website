...
BELANGRIJK: Geef NOOIT standaard antwoorden. Elke reactie moet uniek zijn en aangepast aan de specifieke vraag van de klant. Gebruik verschillende zinsbouw, verschillende voorbeelden, en verschillende manieren van uitleggen. Wees creatief en authentiek in je antwoorden.
...
export default function Chatbot() {
  ...
  const handleOfferteSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      // Simuleer offerte verwerking
      const offerteMessage = `Perfect ${offerteData.contactInfo.naam}! Ik heb je aanvraag ontvangen.
...
Bedankt voor je vertrouwen! Ik kijk ernaar uit om je project te realiseren.`;
      ...
      const errorMessage: Message = {
        role: "assistant",
        content: "Hmm, er ging iets mis met het versturen. Probeer het nog eens, of bel me direct op 015 23 45 67. Dan kunnen we het even bespreken.",
      };
      setMessages((prev) => [...prev, errorMessage]);
    } finally {
      setIsLoading(false);
  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-yannova-primary to-yannova-primary/90 text-white p-4 rounded-t-lg flex justify-between items-center">
            <div>
          ...
          >
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-gray-100 rounded-lg p-3 flex items-center space-x-2 shadow-sm border border-gray-200">
                  ...
                  <span className="text-sm text-gray-600">Yannick is aan het denken...</span>
                </div>
              </div>
            )}
            ...
            <div className="p-4 border-t border-gray-200 bg-gradient-to-b from-gray-50 to-white">
              <form onSubmit={handleOfferteSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yannova-primary text-sm shadow-sm transition-all duration-200"
                      required
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yannova-primary text-sm h-20 resize-none shadow-sm transition-all duration-200"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yannova-primary text-sm shadow-sm transition-all duration-200"
                        required
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yannova-primary text-sm"
                          required
                        />
                      </div>
                    </div>
                ...
                <div className="flex space-x-2 pt-3">
                  ...
                  >
                    {isLoading ? "Bezig..." : "Offerte aanvragen"}
                  </button>
                </div>
              </form>
            </div>
          ...
          {!showOfferteForm && (
            ...
            <div className="flex space-x-2">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yannova-primary text-gray-800 focus-visible:outline-2 focus-visible:outline-yannova-primary focus-visible:outline-offset-2 shadow-sm transition-all duration-200"
                disabled={isLoading}
