...
class YannovaPhotosApiClient {
    ...
    getPhotos() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, node_fetch_1.default)(`${this.baseUrl}/api/photos`);
            if (!response.ok) {
    ...
    getPhoto(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const photos = yield this.getPhotos();
    ...
    deletePhoto(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, node_fetch_1.default)(`${this.baseUrl}/api/photos?id=${id}`, {
                method: 'DELETE',
            });
            if (!response.ok) {
    ...
    generateImages(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, node_fetch_1.default)(`${this.baseUrl}/api/chat`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    analyzePhoto(photoId) {
        return __awaiter(this, void 0, void 0, function* () {
            const photo = yield this.getPhoto(photoId);
