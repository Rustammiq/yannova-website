        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                { img: "/images/ramen-deuren/project-1.jpg", title: "Moderne Villa Ramen" },
                { img: "/images/ramen-deuren/project-2.jpg", title: "Klassieke Houten Kozijnen" },
                { img: "/images/ramen-deuren/project-3.jpg", title: "Aluminium Schuifdeuren" },
                { img: "/images/ramen-deuren/project-4.jpg", title: "Veiligheidsdeur Installatie" },
                { img: "/images/ramen-deuren/project-5.jpg", title: "HR++ Glas Detail" },
                { img: "/images/ramen-deuren/project-6.jpg", title: "Binnendeuren Set" },
                { img: "/images/ramen-deuren/project-7.jpg", title: "Kozijn Renovatie" },
                { img: "/images/ramen-deuren/project-8.jpg", title: "Moderne Voordeur" },
                { img: "/images/ramen-deuren/project-9.jpg", title: "Kunststof Ramen" },
                { img: "/images/ramen-deuren/project-10.jpg", title: "Glaswerk Detail" },
                { img: "/images/ramen-deuren/project-11.jpg", title: "Afdichting Werk" },
                { img: "/images/ramen-deuren/project-12.jpg", title: "Eindresultaat" }
              ].map((item, i) => (
                <div key={i} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow group cursor-pointer">
                  <div className="aspect-square bg-gradient-to-br from-yannova-primary/10 to-yannova-primary/5 flex items-center justify-center relative overflow-hidden">
                    <img 
