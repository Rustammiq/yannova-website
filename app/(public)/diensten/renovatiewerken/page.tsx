            ...
            {renovationSteps.map((step, index) => (
              <div key={index} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className={index % 2 === 1 ? "lg:order-1" : ""}>
                  <div className="aspect-video bg-gradient-to-br from-yannova-primary/20 to-yannova-primary/5 rounded-xl flex items-center justify-center">
                    <span className="text-yannova-primary text-lg font-semibold">
                      [Stap {step.step} foto]
                    </span>
                  </div>
