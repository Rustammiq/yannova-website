...
export const metadata = {
  title: "Aannemer Mechelen | Yannova Bouw",
  description: "Professionele aannemer in Mechelen. Yannova Bouw verzorgt nieuwbouw, renovatie, crepi en verbouwingen in Mechelen en omgeving. Vrijblijvende offerte.",
  keywords: [
    "aannemer Mechelen", "bouwbedrijf Mechelen", "renovatie Mechelen", 
    "nieuwbouw Mechelen", "crepi Mechelen", "verbouwing Mechelen",
    "Yannova Bouw Mechelen", "bouwbedrijf Antwerpen"
  ]
};

export default function MechelenPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Yannova Bouw is uw betrouwbare partner voor alle bouwwerkzaamheden in Mechelen en omgeving
            </p>
            <div className="flex items-center justify-center gap-2 text-yannova-primary">
              <MapPin size={24} />
              <span className="text-lg font-semibold">Mechelen, Antwerpen</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Onze Diensten in Mechelen
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Van kleine renovaties tot complete nieuwbouwprojecten - wij verzorgen alles in Mechelen
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Nieuwbouw Mechelen</h3>
              <p className="text-gray-600 mb-6">
                Complete nieuwbouwprojecten in Mechelen. Van moderne eengezinswoningen tot bedrijfspanden.
              </p>
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Renovatie Mechelen</h3>
              <p className="text-gray-600 mb-6">
                Professionele renovaties in Mechelen. Crepi, ramen, deuren en complete verbouwingen.
              </p>
              <ul className="text-gray-600 text-sm space-y-2">
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Verbouwing Mechelen</h3>
              <p className="text-gray-600 mb-6">
                Uitbreidingen en verbouwingen in Mechelen. Van dakkapel tot complete uitbouw.
              </p>
              <ul className="text-gray-600 text-sm space-y-2">
                <li>• Dakkapellen</li>
                <li>• Uitbouwen</li>
          ...
          {/* Why Choose Yannova in Mechelen */}
          <div className="bg-yannova-primary/5 rounded-xl p-8">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">
                Waarom kiezen voor Yannova Bouw in Mechelen?
              </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">100+ tevreden klanten in Mechelen</p>
              </div>
              <div className="text-center">
                <div className="bg-yannova-primary text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                  <Award size={20} />
      ...
      <section className="bg-yannova-primary py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Klaar voor uw project in Mechelen?
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Neem contact op voor een vrijblijvend gesprek over uw bouwplannen in Mechelen
          </p>
          <a
            href="/contact"
